    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 overflow-hidden">
        ...
        >
          <img
            ...
            className={`w-full h-full object-cover object-bottom transition-all duration-500 ${isDark
      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-2">
            <span
              className={`tracking-tight text-xl font-bold font-sans ${isDark ? 'text-white' : 'text-gray-900'
                }`}
            >
              Sign<span className="text-[#00c4de]">Trust</span>Map
            </span>
            <span
              className={`px-2 py-0.5 rounded-full text-[10px] font-mono font-bold uppercase tracking-wider ${isDark
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className={`w-9 h-9 flex items-center justify-center rounded-full transition-all cursor-pointer active:scale-95 border ${isDark
          ...
          <button
            type="button"
            onClick={toggleLang}
            className={`flex items-center gap-1.5 px-3 py-1.5 rounded-full border transition-all text-xs font-bold font-mono cursor-pointer active:scale-95 shadow-xs ${isDark
          ...
          <a
            ...
            className={`inline-flex items-center gap-1.5 text-xs font-semibold px-3.5 py-1.5 rounded-full border transition-all shadow-xs ${isDark
      ...
      <main className="relative z-20 flex-1 flex items-center justify-center px-4 py-8 w-full">
        <div className="relative w-full max-w-[1280px] flex flex-col items-center justify-center">
          ...
          {/* ─── Main Login Card ───────────────────────────────────────── */}
          <div
            className={`w-full max-w-[480px] rounded-[24px] p-8 sm:p-10 transition-all duration-300 animate-in fade-in zoom-in-95 ${isDark
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5 text-left">
                <label
                  htmlFor="ops-email"
                  className={`text-xs font-bold font-mono uppercase tracking-wide ${isDark ? 'text-[#00c4de]' : 'text-[#007b8b]'
                    }`}
                >
                ...
                <input
                  ...
                  className={`w-full px-4 py-3 text-sm rounded-xl border focus:outline-none focus:ring-2 transition-all ${isDark
              ...
              <div className="flex flex-col gap-1.5 text-left">
                <div className="flex items-center justify-between">
                  ...
                  <a
                    href="#"
                    className={`text-[11px] hover:underline ${isDark ? 'text-[#00c4de]' : 'text-[#007b8b]'
                      }`}
                  >
                ...
                <div className="relative">
                  <input
                    ...
                    placeholder="••••••••"
                    className={`w-full px-4 py-3 pr-10 text-sm rounded-xl border focus:outline-none focus:ring-2 transition-all ${isDark
                        ? 'bg-[#061115] border-white/15 text-white placeholder:text-gray-500 focus:border-[#00c4de] focus:ring-[#00c4de]/25'
                        : 'bg-gray-50/50 border-gray-300 text-gray-900 placeholder:text-gray-400 focus:bg-white focus:border-[#007b8b] focus:ring-[#007b8b]/20'
                      }`}
                  />
              ...
              <button
                ...
                className={`mt-1 w-full py-3.5 text-white font-bold text-sm rounded-full shadow-lg disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98] transition-all flex items-center justify-center gap-2 cursor-pointer ${isDark
              ...
              <div className="relative flex items-center justify-center my-1 w-full">
                ...
                <div className="relative flex justify-center text-xs">
                  <span
                    className={`px-4 text-[11px] font-mono uppercase tracking-widest ${isDark
