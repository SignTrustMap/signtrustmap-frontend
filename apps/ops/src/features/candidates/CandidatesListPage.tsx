...
export const mockCandidates: CandidateItem[] = [
  {
    id: 'CAN-9932',
    priority: 'HIGH',
    reportReason: 'Inaccurate Info - Work History',
    reportedBy: 'J. Smith (Manager)',
    date: 'Oct 24, 09:12',
    status: 'Unresolved',
  },
  {
    id: 'CAN-8421',
    priority: 'MED',
    reportReason: 'Low Quality Portfolio & Metadata',
    reportedBy: 'A. Davis (Reviewer)',
    date: 'Oct 23, 14:45',
    status: 'In Review',
  },
  {
    id: 'CAN-7754',
    priority: 'LOW',
    reportReason: 'Duplicate Profile Suspected',
  ...
  },
  {
    id: 'CAN-9912',
    priority: 'HIGH',
    reportReason: 'Inappropriate Behavior reported',
    reportedBy: 'M. Johnson (User)',
    date: 'Oct 24, 08:05',
    status: 'Unresolved',
  },
]
    ...
    <div className="p-6 sm:p-8 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">
            Moderation queue for flagged profiles requiring admin review.
          </p>
        </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 bg-white p-3.5 px-5 rounded-[14px] border border-[#E8E4E3] shadow-xs">
        <div className="flex flex-wrap items-center gap-4 text-xs">
          <div className="flex items-center gap-2">
            <span className="text-gray-500 font-semibold font-mono">Status:</span>
            <select
              value={statusFilter}
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-500 font-semibold font-mono">Priority:</span>
            <select
          ...
          <div className="flex items-center gap-2">
            <span className="text-gray-500 font-semibold font-mono">Date:</span>
            <select
              value={dateFilter}
      ...
      <div className="bg-white border border-[#E8E4E3] rounded-[16px] shadow-xs overflow-hidden">
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-[#E8E4E3] bg-[#F8F7F7]/60 text-[11px] font-bold uppercase tracking-wider text-gray-500 font-mono">
                ...
                <th className="py-4 px-4">Candidate ID</th>
        ...
        <div className="py-3.5 px-6 border-t border-[#E8E4E3] flex items-center justify-between text-xs text-gray-500">
          <span>Showing 1-{filteredCandidates.length} of 124 candidates</span>

          <div className="flex items-center gap-2">
            <button className="p-1 rounded border border-[#E8E4E3] hover:bg-gray-50 disabled:opacity-40">
              <CaretLeft size={14} />
            </button>
            <span className="font-mono text-xs text-gray-700">Page 1 of 32</span>
