  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none z-0 select-none overflow-hidden">
        ...
        {/* Soft radial scrim behind text (nhẹ để không che wireframe) */}
        <div
      ...
      {/* ─── Open Hero Content (Màu chữ và nút chuẩn như HomePage Hero) ─── */}
      <div className="relative z-10 mx-auto max-w-2xl px-4 text-center flex flex-col items-center">
        {/* Large Typography 403 (Toàn bộ cùng màu như chữ Trust ở trang chính) */}
        ...
        {/* Subtitle (Dùng đúng màu chữ text-gray-200 / text-gray-700 như Hero chính) */}
        <p
        ...
        {/* CTA Buttons (Dùng đúng phong cách & màu sắc nút của Hero chính) */}
